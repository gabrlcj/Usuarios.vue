<template>
  <div class="users">
    <div class="container">
      <h1>Usuários<span class="green">.vue</span></h1>
      <small>
        Pequena aplicação feita em <span class="green">Vue.js</span> na
        Cataline, com uma API REST, feita no curso.
      </small>
      <section>
      ...
      <section>
        <h5 class="title">Listagem de Usuários</h5>
        <ul>
